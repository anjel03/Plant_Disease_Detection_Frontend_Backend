...
filepath = 'C:/Users/ANJALI/Leaf_Disease/Plant-Leaf-Disease-Prediction/Plant-Leaf-Disease-Prediction/model.h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:/Users/ANJALI/Leaf_Disease/Plant-Leaf-Disease-Prediction/Plant-Leaf-Disease-Prediction/static/upload/', filename)
        file.save(file_path)
